...
from media_workflow.activities import adobe_photoshop_thumbnail


async def test_adobe_photoshop_thumbnail():
    input = "https://sunyizhe.s3.us-west-002.backblazeb2.com/%E5%BC%B9%E6%A1%8612.psd"
    output = await adobe_photoshop_thumbnail(input, size=(200, 200))
