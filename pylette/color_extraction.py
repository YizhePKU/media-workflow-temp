...
def median_cut_extraction(
    ...
    colors = [
        Color(tuple(map(int, box.average)), box.pixel_count / total_pixels) for box in c
    ]
...
def extract_colors(
    ...
    Examples:
        Colors can be extracted from a variety of sources, including local files, byte streams, and numpy arrays.
